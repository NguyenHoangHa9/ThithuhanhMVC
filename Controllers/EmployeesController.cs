...
namespace Thithuchanh.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(DepartmentDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Employees != null ? 
                          ...
                          Problem("Entity set 'DepartmentDBContext.Employees'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DepartmentDBContext.Employees'  is null.");
            }
            var employee = await _context.Employees.FindAsync(id);
            if (employee != null)
            {
